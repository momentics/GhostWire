...
4. Дальше трафик уходит через `wss` на 443 порту, то есть выглядит как обычное защищённое HTTPS/WebSocket-соединение.
...
| **Соединений** | Активные WebSocket-соединения и пиковое значение в скобках |
