...
| | |
|:---:|---|
| <img src="resources/icons/ghostwire.png" alt="GhostWire Logo" width="512"> | Графическая оболочка над нативной библиотекой **GhostWire** с защитой от DPI (OSI L4-L7), для **Telegram Desktop**. Приложение работает в системном трее. |
